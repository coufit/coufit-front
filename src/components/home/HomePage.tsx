...
const HomePage: React.FC<HomePageProps> = ({
  ...
  useEffect(() => {
    async function fetchDashboard() {
      setLoading(true);
      try {
        const res = await fetch("http://localhost:8080/api/home/dashboard");
          ...
          {loading || !dashboard ? (
            ...
            <>
              <div className="text-center animate-pulse">
                <div className="h-8 w-24 bg-gray-200 mx-auto mb-2 rounded"></div>
            ...
            <>
              <div className="text-center">
                <div className="text-3xl font-bold text-emerald-600 mb-2">
                  {dashboard.totalStoreCount.toLocaleString()}
                </div>
                <div className="text-gray-600">등록 가맹점</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-emerald-600 mb-2">
                  {dashboard.totalUserCount.toLocaleString()}
                </div>
                <div className="text-gray-600">누적 사용자</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-emerald-600 mb-2">
                  {dashboard.totalPaymentCount.toLocaleString()}
                </div>
