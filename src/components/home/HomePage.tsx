...
const HomePage: React.FC<HomePageProps> = ({ aiModalOpen, setAiModalOpen }) => {
  const [homeSearchQuery, setHomeSearchQuery] = useState("");
  const router = useRouter();

  const handleNavigateToStoreFind = () => {
    router.push("/storeFind");
  };

  const handleHomeSearch = () => {
    router.push(`/storeFind?keyword=${homeSearchQuery}`);
  };
  return (
      ...
      <div className="container mx-auto max-w-[1280px] text-center">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-4 py-4 text-lg border-2 text-black border-gray-200 focus:border-emerald-500 rounded-xl"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button
            ...
            onClick={handleNavigateToStoreFind}
          >
